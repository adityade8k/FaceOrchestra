...
add('melody','spawn','Place the seven melody Honks','Radial menu → Scales → Jog Study. Place apart from the backing. Keep all seven Honks independent: C4, Eb4, E4, F4, G4, Bb4, C5. Both Ga variants and upper Sa are included.',{role:'melody',kind:'honk',catalogId:'jog-melody'});
